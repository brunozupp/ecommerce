<?php 
	...
	$app->get("/categories/:idcategory", function($idcategory) {
		...
		// Fazendo a paginação dos produtos
	...
	$app->get("/checkout", function() {
		...
		// Caso mande sem um campo, vai pegar o cep anterior/que estava
	...
	$app->post("/forgot/reset", function() {
		...
		// Método que verifica se esse meu código já foi usado
	...
	$app->post("/profile", function() {
		...
		// Para evitar injeção de dependências, eu forço esses campos a serem os mesmos que está no banco
		$_POST['inadim'] = $user->getinadim();
